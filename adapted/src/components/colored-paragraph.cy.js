...
describe('ColoredParagraph', () => {
  ...
  it('renders lines in alternating colors', () => {
    ...
    cy.get('span:contains("AR")').should('have.css', 'color', color1)
    cy.get('span:contains("AS")').should('have.css', 'color', color2)
    cy.get('span:contains("BJ")').should('have.css', 'color', color2)
    cy.get('span:contains("BK")').should('have.css', 'color', color3)
    cy.get('span:contains("CA")').should('have.css', 'color', color3)
    cy.get('span:contains("CB")').should('have.css', 'color', color1)
  })
  ...
  it('reacts to window size changes', () => {
    ...
    cy.get('span:contains("AA")').should('have.css', 'color', color1)
    cy.get('span:contains("AN")').should('have.css', 'color', color1)
    cy.get('span:contains("AO")').should('have.css', 'color', color2)
    cy.get('span:contains("BB")').should('have.css', 'color', color2)
    cy.get('span:contains("BC")').should('have.css', 'color', color3)
    cy.get('span:contains("BP")').should('have.css', 'color', color3)
    cy.get('span:contains("BQ")').should('have.css', 'color', color1)
  })
  ...
  it('reacts to text changes', () => {
    ...
    cy.get('span:contains("B7")').should('have.css', 'color', color1)
    cy.get('span:contains("B8")').should('have.css', 'color', color2)
    cy.get('span:contains("D4")').should('have.css', 'color', color2)
    cy.get('span:contains("D5")').should('have.css', 'color', color3)
    cy.get('span:contains("F2")').should('have.css', 'color', color3)
    cy.get('span:contains("F3")').should('have.css', 'color', color1)
  })
