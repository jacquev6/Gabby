...
describe('Gabby', () => {
  ...
  it('modifies existing exercise', () => {
    ...
    cy.screenshot('project-textbook-page-exercise/select-things-color-formatting-button', {clip: {x: 530, y: 855, width: 140, height: 100}})
    cy.get('span[data-cy-colors="2"]').rightclick()
    cy.screenshot('project-textbook-page-exercise/select-things-color-customization', {clip: {x: 400, y: 808, width: 380, height: 100}})
  })
})
