...
describe('Gabby', () => {
  ...
  it('modifies existing exercise', () => {
    ...
    cy.screenshot('project-textbook-page-exercise/select-things-color-formatting-button', {clip: {x: 560, y: 890, width: 140, height: 100}})
    cy.get('span[data-cy-colors="2"]').rightclick()
    cy.screenshot('project-textbook-page-exercise/select-things-color-customization', {clip: {x: 430, y: 820, width: 380, height: 100}})
  })
})
