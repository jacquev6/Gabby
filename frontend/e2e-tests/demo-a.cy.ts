import { loadFixtures, loadPdf, login, notBusy, traceRectangle, visit, selectRange, pressEnter } from "./utils"
...
describe('Gabby', () => {
  ...
  it('creates a "Multiple choices" exercise where you choose a letter to complete words', () => {
    ...
    cy.get('input[data-cy="second-mcq-separator"]').click().type('{selectAll}{del}')
    cy.get('label:contains("Placeholder") + input').click().type('...', {delay: 0})
