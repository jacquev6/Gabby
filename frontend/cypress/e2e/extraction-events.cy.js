    ...
    cy.wrap(getAllExtractionEvents).then(f => f(5)).should('deep.eq', [
      {kind: 'ExerciseNumberSetAutomatically', value: 2},
      {
        ...
        pdf: {
          ...
          page: 1,
          rectangle: {
            start: {x: 55.49873958525407, y: 142.1556772665365},
            stop: {x: 303.099891274904, y: 96.30322871206863},
          },
        },
      ...
      },
      {
        ...
        pdf: {
          ...
          page: 1,
          rectangle: {
            start: {x: 55.49873958525407, y: 105.47371842296229},
            stop: {x: 303.099891274904, y: 59.62126986849444},
          },
        },
