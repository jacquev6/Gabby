...
describe('MultipleChoicesInput', () => {
  ...
  it('works', () => {
    ...
    cy.get('span.choice').should('not.be.visible')

    cy.get('span.main').click()

    cy.get('span.main:contains("....")').should('exist')
    cy.get('span.choice:contains("alpha")').should('exist').should('be.visible')
    cy.get('span.choice:contains("beta")').should('exist').should('be.visible')
