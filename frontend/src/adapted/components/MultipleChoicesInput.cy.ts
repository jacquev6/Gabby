...
describe('MultipleChoicesInput', () => {
  ...
  it('works', () => {
    ...
    cy.get('p.choice').should('not.exist')

    cy.get('span.main').click()

    cy.get('span.main:contains("....")').should('exist')
    cy.get('p.choice:contains("alpha")').should('exist')
    cy.get('p.choice:contains("beta")').should('exist')
    ...
    cy.get('p.choice:contains("alpha")').click().then(() => {
    ...
    cy.get('p.choice:contains("beta")').click().then(() => {
