...
<template>
  <span v-if="colorIndex === 0" @click="increment" :class="{boxed_: boxed}"><slot></slot></span>
  <SelectedText v-else @click="increment" :color="colors[colorIndex - 1]" :boxed><slot></slot></SelectedText>
</template>
