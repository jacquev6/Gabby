...
import AdaptedExercise from '$frontend/views/project/textbook/page/AdaptedExercise.vue'
...
import type { Rectangle, TextItem } from '$/frontend/views/project/textbook/page/TextPicker.vue'
import AdaptationDetailsFieldsForm from '$/frontend/components/AdaptationDetailsFieldsForm.vue'
import TextPicker from '$/frontend/views/project/textbook/page/TextPicker.vue'
