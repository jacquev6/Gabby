...
<template v-if="fields !== null">
  <div>
    <BButton sm primary @click="fields.toggle('bold')" data-cy="bold">{{ $t('boldButton') }}</BButton>
    <BButton sm primary @click="fields.toggle('italic')" data-cy="italic">{{ $t('italicButton') }}</BButton>
  </div>
</template>
