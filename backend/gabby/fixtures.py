...
from .api_models import FillWithFreeTextAdaptation, ItemsAndEffectsAttempt1Adaptation, MultipleChoicesInInstructionsAdaptation, MultipleChoicesInWordingAdaptation, SelectThingsAdaptation
...
def create_test_pings_fixture(session):
    add(session, Ping, created_at=datetime.datetime(2024, 2, 29, 12, 10, 15, tzinfo=datetime.timezone.utc), updated_at=datetime.datetime(2024, 2, 29, 12, 10, 15, tzinfo=datetime.timezone.utc), message='Hello 1')
    ...
    add(session, Ping, created_at=datetime.datetime(2024, 2, 29, 12, 10, 18, tzinfo=datetime.timezone.utc), updated_at=datetime.datetime(2024, 2, 29, 12, 10, 18, tzinfo=datetime.timezone.utc), prev=ping3, message='Hello 4')
    ...
    add(session, Ping, created_at=datetime.datetime(2024, 2, 29, 12, 10, 20, tzinfo=datetime.timezone.utc), updated_at=datetime.datetime(2024, 2, 29, 12, 10, 20, tzinfo=datetime.timezone.utc), prev=ping5, message='Hello 6')
...
def create_test_exercises_1(session, admin):
    ...
    add(session, Exercise, project=project2, textbook=None, textbook_page=None, number='L1', instructions='Faire des choses intelligentes.', example='', clue='', wording='', created_by=admin, updated_by=admin)
    add(session, Exercise, project=project2, textbook=None, textbook_page=None, number='L2', instructions="Faire d'autres choses intelligentes.", example='', clue='', wording='', created_by=admin, updated_by=admin)
    add(session, Exercise, project=project2, textbook=None, textbook_page=None, number='L3', instructions='Prendre le temps de faire aussi des choses banales.', example='', clue='', wording='', created_by=admin, updated_by=admin)
...
def create_test_exercises_3(session, admin):
    ...
    add(
        ...
        textbook=textbook1,
        textbook_page=7,
        bounding_rectangle={'stop': {'x': 303.3652061363319, 'y': 311.45540648703854}, 'start': {'x': 57.45936198048777, 'y': 508.54923588836755}},
        number='7b',
        ...
        adaptation=ItemsAndEffectsAttempt1Adaptation(
            ...
            items=ItemsAndEffectsAttempt1Adaptation.WordsItems(kind="words", punctuation=False),
            effects=ItemsAndEffectsAttempt1Adaptation.Effects(selectable=ItemsAndEffectsAttempt1Adaptation.Effects.Selectable(colors=["#ffff00", "#ffc0cb", "#bbbbff", "#bbffbb"]), boxed=False),
        ),
        created_by=admin,
        updated_by=admin,
    )
...
def create_empty_demo_textbook_fixture(session):
    ...
    add(session, Section, textbook=textbook1, pdf_file=pdffile1, textbook_start_page=1, pdf_file_start_page=1, pages_count=8, created_by=admin, updated_by=admin)
