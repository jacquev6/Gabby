...
class FixturesTestCase(testing.TransactionTestCase, adaptation.AdaptationTestCase):
    ...
    def test_adapt_exercise_1(self):
        from .renderable import Section, Paragraph, Sentence, _PlainText, _Whitespace, _BoxedText, _MultipleChoicesInput
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Complète avec : ', attributes={}), d.TextInsertOp(insert='le, une, un, des, tu, elles, ils', attributes={'choices2': {'start': '', 'separator1': ',', 'separator2': '', 'stop': '', 'placeholder': '...'}}), d.TextInsertOp(insert='.\r\nPuis, souligne les verbes.\n', attributes={})], wording=[d.TextInsertOp(insert='... vide\r\n... vident\r\n... dépenses\r\n... dépensent\r\n... savon\r\n... savons\r\n... commande\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='Il peut y avoir plusieurs solutions.\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()

    def test_adapt_exercise_2(self):
        from .renderable import Section, Paragraph, Sentence, _PlainText, _Whitespace
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert="Écris une phrase en respectant l'ordre des classes grammaticales indiquées.\n", attributes={})], wording=[d.TextInsertOp(insert='nom propre / verbe / déterminant / adjectif / nom commun\n', attributes={})], example=[d.TextInsertOp(insert='pronom personnel / verbe / déterminant / nom commun :\r\nJe mange une pomme.\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_3(self):
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Recopie l’intrus qui se cache dans chaque liste et écris sa classe.\n', attributes={})], wording=[d.TextInsertOp(insert='a. partons ◆ bidons ◆ allons ◆ vendons\r\nb. vidons ◆ mentons ◆ ballons ◆ salons\r\nc. voir ◆ armoire ◆ couloir ◆ dortoir\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_4(self):
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Faire des choses intelligentes.\n', attributes={})], wording=[d.TextInsertOp(insert='\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_5(self):
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert="Faire d'autres choses intelligentes.\n", attributes={})], wording=[d.TextInsertOp(insert='\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_6(self):
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Prendre le temps de faire aussi des choses banales.\n', attributes={})], wording=[d.TextInsertOp(insert='\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()

    def test_adapt_exercise_7(self):
        from .renderable import Section, Paragraph, Sentence, _PlainText, _Whitespace, _SelectedText, _SelectableText
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Relève dans le texte trois\n', attributes={}), d.TextInsertOp(insert='déterminants', attributes={'sel': 1}), d.TextInsertOp(insert=', un ', attributes={}), d.TextInsertOp(insert='nom propre', attributes={'sel': 2}), d.TextInsertOp(insert=', quatre\n', attributes={}), d.TextInsertOp(insert='noms communs', attributes={'sel': 3}), d.TextInsertOp(insert=' et trois ', attributes={}), d.TextInsertOp(insert='verbes', attributes={'sel': 4}), d.TextInsertOp(insert='.\n', attributes={})], wording=[d.TextInsertOp(insert='Les Touaregs sont des Berbères, un peuple qui habite en Afrique du Nord depuis la préhistoire.\nIls vivent dans le désert du Sahara (Algérie, Libye, Mali, Niger, Burkina Faso…).\nEn été, les températures y montent à plus de 50 °C et elles descendent en dessous de zéro durant les nuits d’hiver.\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()

    def test_adapt_exercise_8(self):
        from .renderable import Section, Paragraph, Sentence, _PlainText, _Whitespace, _FreeTextInput
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Ajoute le suffixe –eur aux verbes.\nIndique la classe des mots fabriqués.\n', attributes={})], wording=[d.TextInsertOp(insert='nager ➞ … ◆ tracter ➞ … ◆ manger ➞ … ◆\ninventer ➞ … ◆ livrer ➞ …\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_9(self):
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='Réponds par ', attributes={}), d.TextInsertOp(insert='vrai ou faux', attributes={'choices2': {'start': '', 'separator1': 'ou', 'separator2': '', 'stop': '', 'placeholder': '@'}}), d.TextInsertOp(insert='.\n', attributes={})], wording=[d.TextInsertOp(insert='a. coccinelle est un adjectif. @\nb. bûche est un verbe. @\nc. cette est un déterminant. @\nd. dentier est un verbe. @\ne. respirer est un verbe. @\nf. aspiration est un nom. @\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
    ...
    def test_adapt_exercise_11(self):
        from .renderable import Section, Paragraph, Sentence, _PlainText, _Whitespace, _MultipleChoicesInput, _BoldText, _ItalicText
        ...
        with self.make_session() as session:
            ...
            self.do_test(
                ...
                d.Exercise(instructions=[d.TextInsertOp(insert='...\n', attributes={})], wording=[d.TextInsertOp(insert='a. ', attributes={}), d.TextInsertOp(insert="Aujourd'hui", attributes={'bold': True}), d.TextInsertOp(insert=' il fait ', attributes={}), d.TextInsertOp(insert='gris', attributes={'italic': True}), d.TextInsertOp(insert=' et (il pleuvra / il pleut / il pleuvait).\nb. ', attributes={}), d.TextInsertOp(insert="Aujourd'hui", attributes={'bold': True}), d.TextInsertOp(insert=' il fait ', attributes={}), d.TextInsertOp(insert='gris', attributes={'italic': True}), d.TextInsertOp(insert=' et ', attributes={}), d.TextInsertOp(insert='(il pleuvra / il pleut / il pleuvait)', attributes={'choices2': {'start': '(', 'separator1': '/', 'separator2': '', 'stop': ')', 'placeholder': ''}}), d.TextInsertOp(insert=".\nc. Aujourd'hui il fait @1 et il @2. ", attributes={}), d.TextInsertOp(insert='(gris / beau)', attributes={'choices2': {'start': '(', 'separator1': '/', 'separator2': '', 'stop': ')', 'placeholder': '@1'}}), d.TextInsertOp(insert=' ', attributes={}), d.TextInsertOp(insert='[pleut * pleuvra]', attributes={'choices2': {'start': '[', 'separator1': '*', 'separator2': '', 'stop': ']', 'placeholder': '@2'}}), d.TextInsertOp(insert='\n\n', attributes={})], example=[d.TextInsertOp(insert='\n', attributes={})], clue=[d.TextInsertOp(insert='\n', attributes={})]),
            )
            session.rollback()
            self.expect_rollback()
