...
def create_test_exercises_2(session, admin):
    ...
    add(
        ...
        ExtractionEvent,
        exercise=exercise7,
        event='{"kind":"ExerciseNumberSetManually","value":"7"}',
        created_by=admin,
        updated_by=admin,
    )
    add(
    ...
    add(
        ...
        ExtractionEvent,
        exercise=exercise7,
        event='{"kind":"SelectedTextAddedToInstructions","valueBefore":"","valueAfter":"Relève dans le texte trois\\ndéterminants, un nom propre, quatre\\nnoms communs et trois verbes."}',
        created_by=admin,
        updated_by=admin,
    )
    add(
    ...
    add(
        ...
        ExtractionEvent,
        exercise=exercise7,
        event='{"kind":"SelectedTextAddedToWording","valueBefore":"","valueAfter":"Les Touaregs sont des Berbères, un peuple\\nqui habite en Afrique du Nord depuis la\\npréhistoire. Ils vivent dans le désert du Sahara\\n(Algérie, Libye, Mali, Niger, Burkina Faso…). En\\nété, les températures y montent à plus de 50 °C\\net elles descendent en dessous de zéro durant\\nles nuits d’hiver."}',
        created_by=admin,
        updated_by=admin,
    )
    add(
        ...
        ExtractionEvent,
        exercise=exercise8,
        event='{"kind":"ExerciseNumberSetManually","value":"11"}',
        created_by=admin,
        updated_by=admin,
    )
    add(
    ...
    add(
        ...
        ExtractionEvent,
        exercise=exercise8,
        event='{"kind":"SelectedTextAddedToInstructions","valueBefore":"","valueAfter":"Ajoute le suffixe –eur aux verbes.\\nIndique la classe des mots fabriqués."}',
        created_by=admin,
        updated_by=admin,
    )
    add(
    ...
    add(
        ...
        ExtractionEvent,
        exercise=exercise8,
        event='{"kind":"SelectedTextAddedToWording","valueBefore":"","valueAfter":"nager ➞ … ◆ tracter ➞ … ◆ manger ➞ … ◆\\ninventer ➞ … ◆ livrer ➞ …"}',
        created_by=admin,
        updated_by=admin,
    )
    return (project1, textbook1)
