...
from .old_adaptations.fill_with_free_text import FillWithFreeTextAdaptation, FillWithFreeTextAdaptationsResource
from .old_adaptations.items_and_effects__attempt_1 import ItemsAndEffectsAttempt1Adaptation, ItemsAndEffectsAttempt1AdaptationsResource
from .old_adaptations.multiple_choices_in_instructions import MultipleChoicesInInstructionsAdaptation, MultipleChoicesInInstructionsAdaptationsResource
from .old_adaptations.multiple_choices_in_wording import MultipleChoicesInWordingAdaptation, MultipleChoicesInWordingAdaptationsResource
from .old_adaptations.select_things import SelectThingsAdaptation, SelectThingsAdaptationsResource
