        ...
        self.assertEqual(response.json(), {
            "data": {
                ...
                "attributes": {
                    ...
                    "textReference": [{"insert": "\n", "attributes": {}}],
                    "wordingParagraphsPerPagelet": None,
                    "adaptation": {"kind": "fill-with-free-text", "placeholder_for_fill_with_free_text": "...", "items": None, "items_are_selectable": None, "items_are_boxed": False, "show_arrow_before_mcq_fields": False, "show_mcq_choices_by_default": False},
                    "createdAt": response.json()["data"]["attributes"]["createdAt"],
                    "updatedAt": response.json()["data"]["attributes"]["updatedAt"],
                },
                "relationships": {
