...
class PdfFilesApiTestCase(LoggedInApiTestCase):
    ...
    def test_create__ok(self):
        payload = {
            "data": {
                "type": "pdfFile",
                "attributes": {"sha256": "87428fc522803d31065e7bce3cf03fe475096631e5e07bbd7a0fde60c4cf25c7", "bytesCount": 123456789, "pagesCount": 42},
            }
        }
    ...
    def test_create__short_sha256(self):
        ...
        payload = {"data": {"type": "pdfFile", "attributes": {"sha256": "0263829989b6fd954f7", "bytesCount": 123456789, "pagesCount": 42}}}
        response = self.post("http://server/pdfFiles", payload)
    ...
    def test_create__bad_sha256(self):
        ...
        payload = {
            "data": {
                "type": "pdfFile",
                "attributes": {"sha256": "0263829989b6fd954f72baaf2fc64bc2e2f01d692d4de72986ea808f6e99813x", "bytesCount": 123456789, "pagesCount": 42},
            }
        }
        response = self.post("http://server/pdfFiles", payload)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST, response.json())
        ...
        self.assertEqual(
            response.json(),
            {
                "data": {
                    ...
                    "relationships": {
                        "namings": {"data": [{"type": "pdfFileNaming", "id": "tnahml"}, {"type": "pdfFileNaming", "id": "wmyxrm"}], "meta": {"count": 2}},
                        "sections": {"data": [], "meta": {"count": 0}},
                        "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
                    },
                },
                "included": [
                    {
                        ...
                        "attributes": {"name": "amazing.pdf", "createdAt": naming_1.created_at.isoformat().replace("+00:00", "Z")},
                        "relationships": {
                            "pdfFile": {"data": {"type": "pdfFile", "id": "87428fc522803d31065e7bce3cf03fe475096631e5e07bbd7a0fde60c4cf25c7"}},
                            "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
                        },
                    },
                    {
                        ...
                        "attributes": {"name": "alias.pdf", "createdAt": naming_2.created_at.isoformat().replace("+00:00", "Z")},
                        "relationships": {
                            "pdfFile": {"data": {"type": "pdfFile", "id": "87428fc522803d31065e7bce3cf03fe475096631e5e07bbd7a0fde60c4cf25c7"}},
                            "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
                        },
...
class TextbooksApiTestCase(LoggedInApiTestCase):
    ...
    def test_create__minimal(self):
        payload = {
            "data": {"type": "textbook", "attributes": {"title": "The title"}, "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}}}
        }
    ...
    def test_create__full(self):
        payload = {
            "data": {
                "type": "textbook",
                "attributes": {"title": "The title", "publisher": "The publisher", "year": 2023, "isbn": "9783161484100"},
                "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}},
            }
        }
        response = self.post("http://server/textbooks", payload)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED, response.json())
    ...
    def test_create__bad_isbn(self):
        ...
        payload = {
            "data": {
                "type": "textbook",
                "attributes": {"title": "The title", "isbn": "abcdefgh"},
                "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}},
            }
        }
        response = self.post("http://server/textbooks", payload)
    ...
    def test_list(self):
        ...
        textbook = self.create_model(
            Textbook, project=self.project, title="Yet another title", publisher="Yet another publisher", year=2025, isbn="9783161484102"
        )
        self.create_model(
            Exercise,
            textbook=textbook,
                ...
                "data": [
                    {
                        ...
                        "relationships": {
                            "project": {"data": {"type": "project", "id": "xkopqm"}},
                            "exercises": {
                                "data": [{"type": "exercise", "id": "ufefwu"}, {"type": "exercise", "id": "orxbzq"}, {"type": "exercise", "id": "ahbwey"}],
                                "meta": {"count": 3},
                            },
                            "sections": {"data": [], "meta": {"count": 0}},
                            "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
    ...
    def test_patch__full(self):
        ...
        payload = {
            "data": {
                "type": "textbook",
                "id": "klxufv",
                "attributes": {"title": "The new title", "publisher": "The new publisher", "year": 2024, "isbn": "9783161484101"},
            }
        }
    ...
    def test_patch__partial(self):
        ...
        payload = {"data": {"type": "textbook", "id": "klxufv", "attributes": {"title": "The new title", "year": None}}}
        response = self.patch("http://server/textbooks/klxufv", payload)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.json())
        self.assertEqual(
            response.json(),
    ...
    def test_patch__read_only_project(self):
        ...
        payload = {"data": {"type": "textbook", "id": "klxufv", "relationships": {"project": {"data": {"type": "project", "id": "other"}}}}}
        response = self.patch("http://server/textbooks/klxufv", payload)
...
class ExercisesApiTestCase(LoggedInApiTestCase):
    ...
    def test_create__minimal_without_textbook(self):
        payload = {"data": {"type": "exercise", "attributes": {"number": "42"}, "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}}}}
    ...
    def test_create__minimal_in_textbook(self):
        payload = {
            "data": {
                "type": "exercise",
                "attributes": {"textbookPage": 12, "number": "42", "rectangles": []},
                "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}, "textbook": {"data": {"type": "textbook", "id": "klxufv"}}},
            }
        }
        response = self.post("http://server/exercises", payload)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED, response.json())
    ...
    def test_create__full(self):
        ...
        self.assertEqual(
            ...
            [
                PdfRectangle(
                    pdf_sha256="sha256", pdf_page=42, coordinates="pdfjs", start=Point(x=10, y=20), stop=Point(x=30, y=40), text="text", role="instructions"
                )
            ],
        )
    ...
    def test_list__include_textbook(self):
        ...
        self.create_model(
            Exercise,
            project=other_textbook.project,
                ...
                "included": [
                    {
                        ...
                        "relationships": {
                            "project": {"data": {"type": "project", "id": "xkopqm"}},
                            "exercises": {
                                "data": [{"type": "exercise", "id": "wbqloc"}, {"type": "exercise", "id": "bylced"}, {"type": "exercise", "id": "jkrudc"}],
                                "meta": {"count": 3},
                            },
                            "sections": {"data": [], "meta": {"count": 0}},
                            "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
            ...
            response.json(),
            {
                ...
                "included": [
                    ...
                    },
                    {
                        ...
                        "relationships": {
                            "project": {"data": {"type": "project", "id": "xkopqm"}},
                            "exercises": {"data": [{"type": "exercise", "id": "ufefwu"}], "meta": {"count": 1}},
                            "sections": {"data": [], "meta": {"count": 0}},
                            "createdBy": {"data": {"type": "user", "id": "fvirvd"}},
                            "updatedBy": {"data": {"type": "user", "id": "fvirvd"}},
                        },
    ...
    def test_patch__partial(self):
        ...
        payload = {"data": {"type": "exercise", "id": "wbqloc", "attributes": {"instructions": [{"insert": "INSTRUCTIONS\n", "attributes": {}}]}}}
        response = self.patch("http://server/exercises/wbqloc", payload)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.json())
        self.assertEqual(
            response.json(),
    ...
    def test_patch__read_only_project(self):
        ...
        payload = {"data": {"type": "exercise", "id": "wbqloc", "relationships": {"project": {"data": {"type": "project", "id": "other"}}}}}
        response = self.patch("http://server/exercises/wbqloc", payload)
        self.assertEqual(response.status_code, status.HTTP_422_UNPROCESSABLE_ENTITY, response.json())
        self.assertEqual(
            response.json(),
    ...
    def test_patch__read_only_textbook(self):
        ...
        payload = {"data": {"type": "exercise", "id": "wbqloc", "relationships": {"textbook": {"data": {"type": "textbook", "id": "ojsbmy"}}}}}
        response = self.patch("http://server/exercises/wbqloc", payload)
        self.assertEqual(response.status_code, status.HTTP_422_UNPROCESSABLE_ENTITY, response.json())
        self.assertEqual(
            response.json(),
    ...
    def test_patch__read_only_page(self):
        ...
        payload = {"data": {"type": "exercise", "id": "wbqloc", "attributes": {"textbookPage": 42}}}
        response = self.patch("http://server/exercises/wbqloc", payload)
        self.assertEqual(response.status_code, status.HTTP_422_UNPROCESSABLE_ENTITY, response.json())
        self.assertEqual(
            response.json(),
            {
                "detail": [
                    {"input": 42, "loc": ["body", "data", "attributes", "textbookPage"], "msg": "Extra inputs are not permitted", "type": "extra_forbidden"}
                ]
            },
        )
    ...
    def test_patch__read_only_number(self):
        ...
        payload = {"data": {"type": "exercise", "id": "wbqloc", "attributes": {"number": "12"}}}
        response = self.patch("http://server/exercises/wbqloc", payload)
        self.assertEqual(response.status_code, status.HTTP_422_UNPROCESSABLE_ENTITY, response.json())
        self.assertEqual(
            response.json(),
            {"detail": [{"input": "12", "loc": ["body", "data", "attributes", "number"], "msg": "Extra inputs are not permitted", "type": "extra_forbidden"}]},
        )
...
class BatchingApiTestCase(LoggedInApiTestCase):
    ...
    def test_create_one_projects(self):
        payload = {"atomic:operations": [{"op": "add", "data": {"type": "project", "attributes": {"title": "The project", "description": "Description"}}}]}
    ...
    def test_create_many_projects(self):
        payload = {
            "atomic:operations": [
                {"op": "add", "data": {"type": "project", "attributes": {"title": f"The project {i}", "description": f"Description {i}"}}} for i in range(1, 10)
            ]
        }
        response = self.post("http://server/batch", payload)
        self.assertEqual(response.status_code, status.HTTP_200_OK, response.json())
            ...
            "atomic:operations": [
                {
                    ...
                    "data": {
                        "type": "pdfFile",
                        "lid": "pdf",
                        "attributes": {"sha256": "f8e399a0130a4ec30821821664972e7ad3cf94bc7335db13c1d381494427707c", "bytesCount": 0, "pagesCount": 2},
                        "relationships": {},
                    },
                },
                {
                    ...
                    "data": {
                        ...
                        "relationships": {"pdfFile": {"data": {"type": "pdfFile", "lid": "pdf"}}},
                    },
                },
                {
                    "op": "add",
                    "data": {
                        "type": "textbook",
                        "lid": "tb",
                        "attributes": {"title": "Second textbook"},
                        "relationships": {"project": {"data": {"type": "project", "id": "xkopqm"}}},
                    },
                },
                {
                    ...
                    "data": {
                        "type": "section",
                        "attributes": {"pdfFileStartPage": 1, "pagesCount": 2, "textbookStartPage": 1},
                        "relationships": {"pdfFile": {"data": {"type": "pdfFile", "lid": "pdf"}}, "textbook": {"data": {"type": "textbook", "lid": "tb"}}},
                    },
                },
            ]
        }
